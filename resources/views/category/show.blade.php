...
<div class="container my-4">
    ...
    <div class="container">
        <div class="row">
            ...
            @for($a = 0; $a < 100; $a++)
            <a class="col-md-4 col-sm-6 col-xs-12 mb-4 text-decoration-none text-reset" href="{{route('news.show',['id'=>$news->id])}}">
                <div class="card bg-white">
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-text text-center text-truncate" style="max-width: 100ch;">
                                {{$news->text}}
                            </p>
